...
├── data/
│   └── epu_timeseries.csv       # Final monthly EPU index (2000–2026)
└── figures/
...
```bash
git clone https://github.com/YOUR_USERNAME/greek-epu-index.git
cd greek-epu-index
...
- **Econometrics** — OLS with HAC (Newey-West) standard errors, cross-correlation, Granger causality
